...
public class GetCharactersCharacterIdMailRecipient {
  ...
  public enum RecipientTypeEnum {
    ...
    public static RecipientTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<RecipientTypeEnum> {
      ...
      public RecipientTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return RecipientTypeEnum.fromValue((String)(value));
      }
    }
   ...
   * @return recipientId
  **/
  @Schema(required = true, description = "recipient_id integer")
  ...
  **/
  @Schema(required = true, description = "recipient_type string")
