...
public class GetCharactersCharacterIdIndustryJobs200Ok {
   ...
   * @return activityId
  **/
  @Schema(required = true, description = "Job activity ID")
   ...
   * @return blueprintId
  **/
  @Schema(required = true, description = "blueprint_id integer")
  ...
  **/
  @Schema(required = true, description = "Location ID of the location from which the blueprint was installed. Normally a station ID, but can also be an asset (e.g. container) or corporation facility")
  ...
  **/
  @Schema(required = true, description = "blueprint_type_id integer")
  ...
  **/
  @Schema(description = "ID of the character which completed this job")
  ...
  **/
  @Schema(description = "Date and time when this job was completed")
   ...
   * @return cost
  **/
  @Schema(description = "The sume of job installation fee and industry facility tax")
   ...
   * @return duration
  **/
  @Schema(required = true, description = "Job duration in seconds")
   ...
   * @return endDate
  **/
  @Schema(required = true, description = "Date and time when this job finished")
   ...
   * @return facilityId
  **/
  @Schema(required = true, description = "ID of the facility where this job is running")
   ...
   * @return installerId
  **/
  @Schema(required = true, description = "ID of the character which installed this job")
   ...
   * @return jobId
  **/
  @Schema(required = true, description = "Unique job ID")
   ...
   * @return licensedRuns
  **/
  @Schema(description = "Number of runs blueprint is licensed for")
  ...
  **/
  @Schema(required = true, description = "Location ID of the location to which the output of the job will be delivered. Normally a station ID, but can also be a corporation facility")
   ...
   * @return pauseDate
  **/
  @Schema(description = "Date and time when this job was paused (i.e. time when the facility where this job was installed went offline)")
   ...
   * @return probability
  **/
  @Schema(description = "Chance of success for invention")
  ...
  **/
  @Schema(description = "Type ID of product (manufactured, copied or invented)")
   ...
   * @return runs
  **/
  @Schema(required = true, description = "Number of runs for a manufacturing job, or number of copies to make for a blueprint copy")
   ...
   * @return startDate
  **/
  @Schema(required = true, description = "Date and time when this job started")
   ...
   * @return stationId
  **/
  @Schema(required = true, description = "ID of the station where industry facility is located")
   ...
   * @return status
  **/
  @Schema(required = true, description = "status string")
  ...
  **/
  @Schema(description = "Number of successful runs for this job. Equal to runs unless this is an invention job")
