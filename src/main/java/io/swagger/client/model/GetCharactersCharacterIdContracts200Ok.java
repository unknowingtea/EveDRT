...
public class GetCharactersCharacterIdContracts200Ok {
  ...
  public enum AvailabilityEnum {
    ...
    public static AvailabilityEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<AvailabilityEnum> {
      ...
      public AvailabilityEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return AvailabilityEnum.fromValue((String)(value));
      }
    }
   ...
   * @return acceptorId
  **/
  @Schema(required = true, description = "Who will accept the contract")
   ...
   * @return assigneeId
  **/
  @Schema(required = true, description = "ID to whom the contract is assigned, can be alliance, corporation or character ID")
   ...
   * @return availability
  **/
  @Schema(required = true, description = "To whom the contract is available")
   ...
   * @return buyout
  **/
  @Schema(description = "Buyout price (for Auctions only)")
   ...
   * @return collateral
  **/
  @Schema(description = "Collateral price (for Couriers only)")
   ...
   * @return contractId
  **/
  @Schema(required = true, description = "contract_id integer")
   ...
   * @return dateAccepted
  **/
  @Schema(description = "Date of confirmation of contract")
  ...
  **/
  @Schema(description = "Date of completed of contract")
   ...
   * @return dateExpired
  **/
  @Schema(required = true, description = "Expiration date of the contract")
   ...
   * @return dateIssued
  **/
  @Schema(required = true, description = "Сreation date of the contract")
  ...
  **/
  @Schema(description = "Number of days to perform the contract")
  ...
  **/
  @Schema(description = "End location ID (for Couriers contract)")
  ...
  **/
  @Schema(required = true, description = "true if the contract was issued on behalf of the issuer's corporation")
  ...
  **/
  @Schema(required = true, description = "Character's corporation ID for the issuer")
   ...
   * @return issuerId
  **/
  @Schema(required = true, description = "Character ID for the issuer")
   ...
   * @return price
  **/
  @Schema(description = "Price of contract (for ItemsExchange and Auctions)")
   ...
   * @return reward
  **/
  @Schema(description = "Remuneration for contract (for Couriers only)")
  ...
  **/
  @Schema(description = "Start location ID (for Couriers contract)")
   ...
   * @return status
  **/
  @Schema(required = true, description = "Status of the the contract")
  ...
  **/
   ...
   * @return type
  **/
  @Schema(required = true, description = "Type of the contract")
   ...
   * @return volume
  **/
  @Schema(description = "Volume of items in the contract")
