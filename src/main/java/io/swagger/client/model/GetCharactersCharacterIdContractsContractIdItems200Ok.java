...
public class GetCharactersCharacterIdContractsContractIdItems200Ok {
  ...
  **/
   ...
   * @return isSingleton
  **/
  @Schema(required = true, description = "is_singleton boolean")
  ...
  **/
   ...
   * @return rawQuantity
  **/
  @Schema(description = "-1 indicates that the item is a singleton (non-stackable). If the item happens to be a Blueprint, -1 is an Original and -2 is a Blueprint Copy")
   ...
   * @return recordId
  **/
  @Schema(required = true, description = "Unique ID for the item")
