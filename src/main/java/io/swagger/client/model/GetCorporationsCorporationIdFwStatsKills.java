 ...
 */
@Schema(description = "Summary of kills done by the given corporation against enemy factions")
...
public class GetCorporationsCorporationIdFwStatsKills {
   ...
   * @return lastWeek
  **/
  @Schema(required = true, description = "Last week's total number of kills by members of the given corporation against enemy factions")
   ...
   * @return total
  **/
  @Schema(required = true, description = "Total number of kills by members of the given corporation against enemy factions since the corporation enlisted")
   ...
   * @return yesterday
  **/
  @Schema(required = true, description = "Yesterday's total number of kills by members of the given corporation against enemy factions")
