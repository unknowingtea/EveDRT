...
import io.swagger.client.model.GetUniverseTypesTypeIdDogmaAttribute;
import io.swagger.client.model.GetUniverseTypesTypeIdDogmaEffect;
...
public class GetUniverseTypesTypeIdOk {
   ...
   * @return capacity
  **/
  @Schema(description = "capacity number")
  ...
  **/
  @Schema(description = "dogma_attributes array")
   ...
   * @return dogmaEffects
  **/
  @Schema(description = "dogma_effects array")
   ...
   * @return graphicId
  **/
  @Schema(description = "graphic_id integer")
   ...
   * @return groupId
  **/
  @Schema(required = true, description = "group_id integer")
  ...
  **/
  @Schema(description = "This only exists for types that can be put on the market")
   ...
   * @return mass
  **/
  @Schema(description = "mass number")
  ...
  **/
  @Schema(description = "packaged_volume number")
   ...
   * @return portionSize
  **/
  @Schema(description = "portion_size integer")
  ...
  **/
   ...
   * @return radius
  **/
  @Schema(description = "radius number")
  ...
  **/
   ...
   * @return volume
  **/
  @Schema(description = "volume number")
