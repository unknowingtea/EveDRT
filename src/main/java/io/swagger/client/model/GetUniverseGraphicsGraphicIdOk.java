...
public class GetUniverseGraphicsGraphicIdOk {
  ...
  **/
  @Schema(description = "collision_file string")
   ...
   * @return graphicFile
  **/
  @Schema(description = "graphic_file string")
   ...
   * @return graphicId
  **/
  @Schema(required = true, description = "graphic_id integer")
   ...
   * @return iconFolder
  **/
  @Schema(description = "icon_folder string")
   ...
   * @return sofDna
  **/
  @Schema(description = "sof_dna string")
  ...
  **/
  @Schema(description = "sof_fation_name string")
   ...
   * @return sofHullName
  **/
  @Schema(description = "sof_hull_name string")
   ...
   * @return sofRaceName
  **/
  @Schema(description = "sof_race_name string")
