...
public class GetCorporationsCorporationIdContainersLogs200Ok {
  ...
  public enum PasswordTypeEnum {
    ...
    public static PasswordTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<PasswordTypeEnum> {
      ...
      public PasswordTypeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return PasswordTypeEnum.fromValue((String)(value));
      }
    }
   ...
   * @return action
  **/
  @Schema(required = true, description = "action string")
   ...
   * @return characterId
  **/
  @Schema(required = true, description = "ID of the character who performed the action.")
   ...
   * @return containerId
  **/
  @Schema(required = true, description = "ID of the container")
  ...
  **/
  @Schema(required = true, description = "Type ID of the container")
   ...
   * @return locationFlag
  **/
  @Schema(required = true, description = "location_flag string")
  ...
  **/
   ...
   * @return loggedAt
  **/
  @Schema(required = true, description = "Timestamp when this log was created")
  ...
  **/
  @Schema(description = "new_config_bitmask integer")
  ...
  **/
  @Schema(description = "old_config_bitmask integer")
   ...
   * @return passwordType
  **/
  @Schema(description = "Type of password set if action is of type SetPassword or EnterPassword")
   ...
   * @return quantity
  **/
  @Schema(description = "Quantity of the item being acted upon")
   ...
   * @return typeId
  **/
  @Schema(description = "Type ID of the item being acted upon")
