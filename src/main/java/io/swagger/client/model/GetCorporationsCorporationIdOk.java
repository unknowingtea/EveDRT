...
public class GetCorporationsCorporationIdOk {
   ...
   * @return allianceId
  **/
  @Schema(description = "ID of the alliance that corporation is a member of, if any")
   ...
   * @return ceoId
  **/
  @Schema(required = true, description = "ceo_id integer")
  ...
  **/
   ...
   * @return dateFounded
  **/
  @Schema(description = "date_founded string")
  ...
  **/
  @Schema(description = "home_station_id integer")
   ...
   * @return memberCount
  **/
  @Schema(required = true, description = "member_count integer")
   ...
   * @return name
  **/
  @Schema(required = true, description = "the full name of the corporation")
   ...
   * @return shares
  **/
  @Schema(description = "shares integer")
   ...
   * @return taxRate
  **/
  @Schema(required = true, description = "tax_rate number")
   ...
   * @return ticker
  **/
  @Schema(required = true, description = "the short name of the corporation")
  ...
  **/
   ...
   * @return warEligible
  **/
  @Schema(description = "war_eligible boolean")
