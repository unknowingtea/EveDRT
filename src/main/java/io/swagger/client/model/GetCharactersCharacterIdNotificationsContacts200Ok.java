...
public class GetCharactersCharacterIdNotificationsContacts200Ok {
  ...
  **/
   ...
   * @return sendDate
  **/
  @Schema(required = true, description = "send_date string")
  ...
  **/
  @Schema(required = true, description = "sender_character_id integer")
  ...
  **/
  @Schema(required = true, description = "A number representing the standing level the receiver has been added at by the sender. The standing levels are as follows: -10 -> Terrible | -5 -> Bad |  0 -> Neutral |  5 -> Good |  10 -> Excellent")
