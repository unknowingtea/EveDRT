...
public class GetCharactersCharacterIdPlanets200Ok {
  ...
  public enum PlanetTypeEnum {
    ...
    public static PlanetTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<PlanetTypeEnum> {
      ...
      public PlanetTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return PlanetTypeEnum.fromValue((String)(value));
      }
    }
   ...
   * @return lastUpdate
  **/
  @Schema(required = true, description = "last_update string")
   ...
   * @return numPins
  **/
  @Schema(required = true, description = "num_pins integer")
  ...
  **/
   ...
   * @return planetType
  **/
  @Schema(required = true, description = "planet_type string")
  ...
  **/
   ...
   * @return upgradeLevel
  **/
  @Schema(required = true, description = "upgrade_level integer")
