...
import io.swagger.client.model.GetFwLeaderboardsCorporationsActiveTotalActiveTotal;
import io.swagger.client.model.GetFwLeaderboardsCorporationsLastWeekLastWeek;
import io.swagger.client.model.GetFwLeaderboardsCorporationsYesterdayYesterday;
 ...
 */
@Schema(description = "Top 10 rankings of corporations by number of kills from yesterday, last week and in total")
...
public class GetFwLeaderboardsCorporationsKills {
   ...
   * @return activeTotal
  **/
  @Schema(required = true, description = "Top 10 ranking of corporations active in faction warfare by total kills. A corporation is considered \"active\" if they have participated in faction warfare in the past 14 days")
   ...
   * @return lastWeek
  **/
  @Schema(required = true, description = "Top 10 ranking of corporations by kills in the past week")
   ...
   * @return yesterday
  **/
  @Schema(required = true, description = "Top 10 ranking of corporations by kills in the past day")
