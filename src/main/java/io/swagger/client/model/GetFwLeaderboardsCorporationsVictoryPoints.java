...
import io.swagger.client.model.GetFwLeaderboardsCorporationsActiveTotalActiveTotal1;
import io.swagger.client.model.GetFwLeaderboardsCorporationsLastWeekLastWeek1;
import io.swagger.client.model.GetFwLeaderboardsCorporationsYesterdayYesterday1;
 ...
 */
@Schema(description = "Top 10 rankings of corporations by victory points from yesterday, last week and in total")
...
public class GetFwLeaderboardsCorporationsVictoryPoints {
   ...
   * @return activeTotal
  **/
  @Schema(required = true, description = "Top 10 ranking of corporations active in faction warfare by total victory points. A corporation is considered \"active\" if they have participated in faction warfare in the past 14 days")
   ...
   * @return lastWeek
  **/
  @Schema(required = true, description = "Top 10 ranking of corporations by victory points in the past week")
   ...
   * @return yesterday
  **/
  @Schema(required = true, description = "Top 10 ranking of corporations by victory points in the past day")
