...
public class GetCorporationCorporationIdMiningObservers200Ok {
  ...
  public enum ObserverTypeEnum {
    ...
    public static ObserverTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<ObserverTypeEnum> {
      ...
      public ObserverTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return ObserverTypeEnum.fromValue((String)(value));
      }
    }
  ...
  **/
   ...
   * @return observerId
  **/
  @Schema(required = true, description = "The entity that was observing the asteroid field when it was mined. ")
   ...
   * @return observerType
  **/
  @Schema(required = true, description = "The category of the observing entity")
