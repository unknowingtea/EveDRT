...
public class GetCharactersCharacterIdContacts200Ok {
  ...
  public enum ContactTypeEnum {
    ...
    public static ContactTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<ContactTypeEnum> {
      ...
      public ContactTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return ContactTypeEnum.fromValue((String)(value));
      }
    }
   ...
   * @return contactId
  **/
  @Schema(required = true, description = "contact_id integer")
   ...
   * @return contactType
  **/
  @Schema(required = true, description = "contact_type string")
   ...
   * @return isBlocked
  **/
  @Schema(description = "Whether this contact is in the blocked list. Note a missing value denotes unknown, not true or false")
   ...
   * @return isWatched
  **/
  @Schema(description = "Whether this contact is being watched")
   ...
   * @return labelIds
  **/
  @Schema(description = "label_ids array")
   ...
   * @return standing
  **/
  @Schema(required = true, description = "Standing of the contact")
