...
public class GetUniverseConstellationsConstellationIdOk {
  ...
  **/
  @Schema(required = true, description = "constellation_id integer")
  ...
  **/
   ...
   * @return regionId
  **/
  @Schema(required = true, description = "The region this constellation is in")
   ...
   * @return systems
  **/
  @Schema(required = true, description = "systems array")
