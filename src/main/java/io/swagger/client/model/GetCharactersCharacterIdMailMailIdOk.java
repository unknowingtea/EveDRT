...
public class GetCharactersCharacterIdMailMailIdOk {
   ...
   * @return body
  **/
  @Schema(description = "Mail's body")
   ...
   * @return from
  **/
  @Schema(description = "From whom the mail was sent")
   ...
   * @return labels
  **/
  @Schema(description = "Labels attached to the mail")
  ...
  **/
   ...
   * @return recipients
  **/
  @Schema(description = "Recipients of the mail")
   ...
   * @return subject
  **/
  @Schema(description = "Mail subject")
   ...
   * @return timestamp
  **/
  @Schema(description = "When the mail was sent")
