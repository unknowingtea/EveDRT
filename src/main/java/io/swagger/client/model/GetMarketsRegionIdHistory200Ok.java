...
public class GetMarketsRegionIdHistory200Ok {
   ...
   * @return average
  **/
  @Schema(required = true, description = "average number")
   ...
   * @return date
  **/
  @Schema(required = true, description = "The date of this historical statistic entry")
   ...
   * @return highest
  **/
  @Schema(required = true, description = "highest number")
   ...
   * @return lowest
  **/
  @Schema(required = true, description = "lowest number")
   ...
   * @return orderCount
  **/
  @Schema(required = true, description = "Total number of orders happened that day")
   ...
   * @return volume
  **/
  @Schema(required = true, description = "Total")
