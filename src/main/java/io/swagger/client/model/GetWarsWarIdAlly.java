 ...
 * ally object
 */
@Schema(description = "ally object")
...
public class GetWarsWarIdAlly {
   ...
   * @return allianceId
  **/
  @Schema(description = "Alliance ID if and only if this ally is an alliance")
  ...
  **/
  @Schema(description = "Corporation ID if and only if this ally is a corporation")
