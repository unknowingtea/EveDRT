...
public class GetCharactersCharacterIdOnlineOk {
  ...
  **/
   ...
   * @return lastLogout
  **/
  @Schema(description = "Timestamp of the last logout")
   ...
   * @return logins
  **/
  @Schema(description = "Total number of times the character has logged in")
   ...
   * @return online
  **/
  @Schema(required = true, description = "If the character is online")
