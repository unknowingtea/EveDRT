...
public class GetSovereigntyCampaigns200Ok {
  ...
  **/
  @Schema(description = "Score for all attacking parties, only present in Defense Events. ")
   ...
   * @return campaignId
  **/
  @Schema(required = true, description = "Unique ID for this campaign.")
  ...
  **/
  @Schema(required = true, description = "The constellation in which the campaign will take place. ")
   ...
   * @return defenderId
  **/
  @Schema(description = "Defending alliance, only present in Defense Events ")
  ...
  **/
  @Schema(description = "Score for the defending alliance, only present in Defense Events. ")
   ...
   * @return eventType
  **/
  @Schema(required = true, description = "Type of event this campaign is for. tcu_defense, ihub_defense and station_defense are referred to as \"Defense Events\", station_freeport as \"Freeport Events\". ")
   ...
   * @return participants
  **/
  @Schema(description = "Alliance participating and their respective scores, only present in Freeport Events. ")
  ...
  **/
  @Schema(required = true, description = "The solar system the structure is located in. ")
   ...
   * @return startTime
  **/
  @Schema(required = true, description = "Time the event is scheduled to start. ")
   ...
   * @return structureId
  **/
  @Schema(required = true, description = "The structure item ID that is related to this campaign. ")
