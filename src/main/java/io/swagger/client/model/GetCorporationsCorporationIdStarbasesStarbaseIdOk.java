...
import io.swagger.client.model.GetCorporationsCorporationIdStarbasesStarbaseIdFuel;
...
public class GetCorporationsCorporationIdStarbasesStarbaseIdOk {
  ...
  public enum FuelBayTakeEnum {
    ...
    public static FuelBayTakeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<FuelBayTakeEnum> {
      ...
      public FuelBayTakeEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return FuelBayTakeEnum.fromValue((String)(value));
      }
    }
  ...
  public enum FuelBayViewEnum {
    ...
    public static FuelBayViewEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<FuelBayViewEnum> {
      ...
      public FuelBayViewEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return FuelBayViewEnum.fromValue((String)(value));
      }
    }
  ...
  public enum OfflineEnum {
    ...
    public static OfflineEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<OfflineEnum> {
      ...
      public OfflineEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return OfflineEnum.fromValue((String)(value));
      }
    }
  ...
  public enum OnlineEnum {
    ...
    public static OnlineEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<OnlineEnum> {
      ...
      public OnlineEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return OnlineEnum.fromValue((String)(value));
      }
    }
  ...
  public enum UnanchorEnum {
    ...
    public static UnanchorEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<UnanchorEnum> {
      ...
      public UnanchorEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return UnanchorEnum.fromValue((String)(value));
      }
    }
  ...
  **/
  @Schema(required = true, description = "allow_alliance_members boolean")
  ...
  **/
  @Schema(required = true, description = "allow_corporation_members boolean")
   ...
   * @return anchor
  **/
  @Schema(required = true, description = "Who can anchor starbase (POS) and its structures")
  ...
  **/
  @Schema(required = true, description = "attack_if_at_war boolean")
  ...
  **/
  @Schema(required = true, description = "attack_if_other_security_status_dropping boolean")
  ...
  **/
  @Schema(description = "Starbase (POS) will attack if target's security standing is lower than this value")
  ...
  **/
  @Schema(description = "Starbase (POS) will attack if target's standing is lower than this value")
   ...
   * @return fuelBayTake
  **/
  @Schema(required = true, description = "Who can take fuel blocks out of the starbase (POS)'s fuel bay")
   ...
   * @return fuelBayView
  **/
  @Schema(required = true, description = "Who can view the starbase (POS)'s fule bay. Characters either need to have required role or belong to the starbase (POS) owner's corporation or alliance, as described by the enum, all other access settings follows the same scheme")
   ...
   * @return fuels
  **/
  @Schema(description = "Fuel blocks and other things that will be consumed when operating a starbase (POS)")
   ...
   * @return offline
  **/
  @Schema(required = true, description = "Who can offline starbase (POS) and its structures")
   ...
   * @return online
  **/
  @Schema(required = true, description = "Who can online starbase (POS) and its structures")
   ...
   * @return unanchor
  **/
  @Schema(required = true, description = "Who can unanchor starbase (POS) and its structures")
  ...
  **/
  @Schema(required = true, description = "True if the starbase (POS) is using alliance standings, otherwise using corporation's")
