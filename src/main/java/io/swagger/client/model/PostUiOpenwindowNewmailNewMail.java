 ...
 * new_mail object
 */
@Schema(description = "new_mail object")
...
public class PostUiOpenwindowNewmailNewMail {
   ...
   * @return body
  **/
  @Schema(required = true, description = "body string")
   ...
   * @return recipients
  **/
  @Schema(required = true, description = "recipients array")
   ...
   * @return subject
  **/
  @Schema(required = true, description = "subject string")
  ...
  **/
  @Schema(description = "to_corp_or_alliance_id integer")
  ...
  **/
  @Schema(description = "Corporations, alliances and mailing lists are all types of mailing groups. You may only send to one mailing group, at a time, so you may fill out either this field or the to_corp_or_alliance_ids field")
