...
public class GetIndustryFacilities200Ok {
   ...
   * @return facilityId
  **/
  @Schema(required = true, description = "ID of the facility")
   ...
   * @return ownerId
  **/
  @Schema(required = true, description = "Owner of the facility")
   ...
   * @return regionId
  **/
  @Schema(required = true, description = "Region ID where the facility is")
  ...
  **/
  @Schema(required = true, description = "Solar system ID where the facility is")
   ...
   * @return tax
  **/
  @Schema(description = "Tax imposed by the facility")
  public Float getTax() {
    return tax;
  }
   ...
   * @return typeId
  **/
  @Schema(required = true, description = "Type ID of the facility")
