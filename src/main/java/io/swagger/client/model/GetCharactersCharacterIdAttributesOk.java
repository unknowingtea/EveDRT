...
public class GetCharactersCharacterIdAttributesOk {
  ...
  **/
  @Schema(description = "Neural remapping cooldown after a character uses remap accrued over time")
   ...
   * @return bonusRemaps
  **/
  @Schema(description = "Number of available bonus character neural remaps")
  ...
  **/
  @Schema(description = "Datetime of last neural remap, including usage of bonus remaps")
