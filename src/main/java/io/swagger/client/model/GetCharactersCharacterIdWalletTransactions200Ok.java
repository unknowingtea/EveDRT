...
public class GetCharactersCharacterIdWalletTransactions200Ok {
   ...
   * @return clientId
  **/
  @Schema(required = true, description = "client_id integer")
  ...
  **/
   ...
   * @return isBuy
  **/
  @Schema(required = true, description = "is_buy boolean")
   ...
   * @return isPersonal
  **/
  @Schema(required = true, description = "is_personal boolean")
   ...
   * @return journalRefId
  **/
  @Schema(required = true, description = "journal_ref_id integer")
  ...
  **/
  @Schema(required = true, description = "Unique transaction ID")
  ...
  **/
   ...
   * @return unitPrice
  **/
  @Schema(required = true, description = "Amount paid per unit")
