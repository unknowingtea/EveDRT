...
public class GetCharactersCharacterIdStandings200Ok {
  ...
  public enum FromTypeEnum {
    ...
    public static FromTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<FromTypeEnum> {
      ...
      public FromTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return FromTypeEnum.fromValue((String)(value));
      }
    }
   ...
   * @return fromId
  **/
  @Schema(required = true, description = "from_id integer")
   ...
   * @return fromType
  **/
  @Schema(required = true, description = "from_type string")
   ...
   * @return standing
  **/
  @Schema(required = true, description = "standing number")
