 ...
 */
@Schema(description = "The defending corporation or alliance that declared this war, only contains either corporation_id or alliance_id")
...
public class GetWarsWarIdDefender {
   ...
   * @return allianceId
  **/
  @Schema(description = "Alliance ID if and only if the defender is an alliance")
  ...
  **/
  @Schema(description = "Corporation ID if and only if the defender is a corporation")
   ...
   * @return iskDestroyed
  **/
  @Schema(required = true, description = "ISK value of ships the defender has killed")
   ...
   * @return shipsKilled
  **/
  @Schema(required = true, description = "The number of ships the defender has killed")
