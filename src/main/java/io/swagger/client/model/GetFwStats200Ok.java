...
import io.swagger.client.model.GetFwStatsKills;
import io.swagger.client.model.GetFwStatsVictoryPoints;
...
public class GetFwStats200Ok {
  ...
  **/
   ...
   * @return pilots
  **/
  @Schema(required = true, description = "How many pilots fight for the given faction")
  ...
  **/
  @Schema(required = true, description = "The number of solar systems controlled by the given faction")
