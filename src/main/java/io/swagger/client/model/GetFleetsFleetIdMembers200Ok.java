...
public class GetFleetsFleetIdMembers200Ok {
  ...
  **/
   ...
   * @return joinTime
  **/
  @Schema(required = true, description = "join_time string")
  ...
  **/
   ...
   * @return roleName
  **/
  @Schema(required = true, description = "Localized role names")
  ...
  **/
  @Schema(required = true, description = "Solar system the member is located in")
  ...
  **/
   ...
   * @return stationId
  **/
  @Schema(description = "Station in which the member is docked in, if applicable")
  ...
  **/
  @Schema(required = true, description = "Whether the member take fleet warps")
