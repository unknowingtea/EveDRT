...
public class GetFwSystems200Ok {
  ...
  public enum ContestedEnum {
    ...
    public static ContestedEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<ContestedEnum> {
      ...
      public ContestedEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return ContestedEnum.fromValue((String)(value));
      }
    }
   ...
   * @return contested
  **/
  @Schema(required = true, description = "contested string")
  ...
  **/
  @Schema(required = true, description = "occupier_faction_id integer")
  ...
  **/
  @Schema(required = true, description = "owner_faction_id integer")
  ...
  **/
  @Schema(required = true, description = "victory_points integer")
  ...
  **/
  @Schema(required = true, description = "victory_points_threshold integer")
