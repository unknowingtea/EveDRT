...
public class GetIncursions200Ok {
  ...
  **/
  @Schema(required = true, description = "The constellation id in which this incursion takes place")
   ...
   * @return factionId
  **/
  @Schema(required = true, description = "The attacking faction's id")
   ...
   * @return hasBoss
  **/
  @Schema(required = true, description = "Whether the final encounter has boss or not")
  ...
  **/
  @Schema(required = true, description = "A list of infested solar system ids that are a part of this incursion")
   ...
   * @return influence
  **/
  @Schema(required = true, description = "Influence of this incursion as a float from 0 to 1")
  ...
  **/
  @Schema(required = true, description = "Staging solar system for this incursion")
   ...
   * @return state
  **/
  @Schema(required = true, description = "The state of this incursion")
   ...
   * @return type
  **/
  @Schema(required = true, description = "The type of this incursion")
