...
public class GetCorporationsCorporationIdMedalsIssued200Ok {
   ...
   * @return characterId
  **/
  @Schema(required = true, description = "ID of the character who was rewarded this medal")
   ...
   * @return issuedAt
  **/
  @Schema(required = true, description = "issued_at string")
   ...
   * @return issuerId
  **/
  @Schema(required = true, description = "ID of the character who issued the medal")
   ...
   * @return medalId
  **/
  @Schema(required = true, description = "medal_id integer")
   ...
   * @return reason
  **/
  @Schema(required = true, description = "reason string")
