...
public class PostCharactersAffiliation200Ok {
   ...
   * @return allianceId
  **/
  @Schema(description = "The character's alliance ID, if their corporation is in an alliance")
   ...
   * @return characterId
  **/
  @Schema(required = true, description = "The character's ID")
  ...
  **/
   ...
   * @return factionId
  **/
  @Schema(description = "The character's faction ID, if their corporation is in a faction")
