 ...
 */
@Schema(description = "Full details of a specific event")
...
public class GetCharactersCharacterIdCalendarEventIdOk {
  ...
  **/
   ...
   * @return duration
  **/
  @Schema(required = true, description = "Length in minutes")
   ...
   * @return eventId
  **/
  @Schema(required = true, description = "event_id integer")
   ...
   * @return importance
  **/
  @Schema(required = true, description = "importance integer")
   ...
   * @return ownerId
  **/
  @Schema(required = true, description = "owner_id integer")
   ...
   * @return ownerName
  **/
  @Schema(required = true, description = "owner_name string")
   ...
   * @return ownerType
  **/
  @Schema(required = true, description = "owner_type string")
  ...
  **/
   ...
   * @return text
  **/
  @Schema(required = true, description = "text string")
   ...
   * @return title
  **/
  @Schema(required = true, description = "title string")
