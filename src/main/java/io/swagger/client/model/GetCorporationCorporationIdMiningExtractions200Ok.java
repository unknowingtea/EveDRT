...
public class GetCorporationCorporationIdMiningExtractions200Ok {
  ...
  **/
  @Schema(required = true, description = "The time at which the chunk being extracted will arrive and can be fractured by the moon mining drill. ")
  ...
  **/
  @Schema(required = true, description = "The time at which the current extraction was initiated. ")
   ...
   * @return moonId
  **/
  @Schema(required = true, description = "moon_id integer")
  ...
  **/
  @Schema(required = true, description = "The time at which the chunk being extracted will naturally fracture if it is not first fractured by the moon mining drill. ")
   ...
   * @return structureId
  **/
  @Schema(required = true, description = "structure_id integer")
