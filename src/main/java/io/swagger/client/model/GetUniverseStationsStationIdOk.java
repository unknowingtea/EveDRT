...
import io.swagger.client.model.GetUniverseStationsStationIdPosition;
...
public class GetUniverseStationsStationIdOk {
  ...
  public enum ServicesEnum {
    ...
    public static ServicesEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<ServicesEnum> {
      ...
      public ServicesEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return ServicesEnum.fromValue((String)(value));
      }
    }
  ...
  **/
  @Schema(required = true, description = "max_dockable_ship_volume number")
  ...
  **/
  @Schema(required = true, description = "office_rental_cost number")
   ...
   * @return owner
  **/
  @Schema(description = "ID of the corporation that controls this station")
  ...
  **/
   ...
   * @return raceId
  **/
  @Schema(description = "race_id integer")
  ...
  **/
  @Schema(required = true, description = "reprocessing_efficiency number")
  ...
  **/
  @Schema(required = true, description = "reprocessing_stations_take number")
   ...
   * @return services
  **/
  @Schema(required = true, description = "services array")
   ...
   * @return stationId
  **/
  @Schema(required = true, description = "station_id integer")
   ...
   * @return systemId
  **/
  @Schema(required = true, description = "The solar system this station is in")
