...
public class GetCorporationsCorporationIdMembertracking200Ok {
   ...
   * @return baseId
  **/
  @Schema(description = "base_id integer")
  ...
  **/
   ...
   * @return locationId
  **/
  @Schema(description = "location_id integer")
   ...
   * @return logoffDate
  **/
  @Schema(description = "logoff_date string")
   ...
   * @return logonDate
  **/
  @Schema(description = "logon_date string")
   ...
   * @return shipTypeId
  **/
  @Schema(description = "ship_type_id integer")
