...
public class GetCorporationsCorporationIdRolesHistory200Ok {
  ...
  public enum NewRolesEnum {
    ...
    public static NewRolesEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<NewRolesEnum> {
      ...
      public NewRolesEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return NewRolesEnum.fromValue((String)(value));
      }
    }
  ...
  public enum OldRolesEnum {
    ...
    public static OldRolesEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<OldRolesEnum> {
      ...
      public OldRolesEnum read(final JsonReader jsonReader) throws IOException {
        Object value = jsonReader.nextString();
        return OldRolesEnum.fromValue((String)(value));
      }
    }
   ...
   * @return changedAt
  **/
  @Schema(required = true, description = "changed_at string")
   ...
   * @return characterId
  **/
  @Schema(required = true, description = "The character whose roles are changed")
   ...
   * @return issuerId
  **/
  @Schema(required = true, description = "ID of the character who issued this change")
   ...
   * @return newRoles
  **/
  @Schema(required = true, description = "new_roles array")
   ...
   * @return oldRoles
  **/
  @Schema(required = true, description = "old_roles array")
   ...
   * @return roleType
  **/
  @Schema(required = true, description = "role_type string")
