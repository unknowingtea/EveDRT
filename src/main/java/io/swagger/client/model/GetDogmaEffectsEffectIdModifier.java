 ...
 * modifier object
 */
@Schema(description = "modifier object")
...
public class GetDogmaEffectsEffectIdModifier {
   ...
   * @return domain
  **/
  @Schema(description = "domain string")
   ...
   * @return effectId
  **/
  @Schema(description = "effect_id integer")
   ...
   * @return func
  **/
  @Schema(required = true, description = "func string")
  ...
  **/
  @Schema(description = "modified_attribute_id integer")
  ...
  **/
  @Schema(description = "modifying_attribute_id integer")
   ...
   * @return operator
  **/
  @Schema(description = "operator integer")
