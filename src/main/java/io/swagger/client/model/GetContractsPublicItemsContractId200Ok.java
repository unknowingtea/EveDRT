...
public class GetContractsPublicItemsContractId200Ok {
  ...
  **/
  @Schema(description = "is_blueprint_copy boolean")
   ...
   * @return isIncluded
  **/
  @Schema(required = true, description = "true if the contract issuer has submitted this item with the contract, false if the isser is asking for this item in the contract")
   ...
   * @return itemId
  **/
  @Schema(description = "Unique ID for the item being sold. Not present if item is being requested by contract rather than sold with contract")
  ...
  **/
  @Schema(description = "Material Efficiency Level of the blueprint")
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "Number of items in the stack")
   ...
   * @return recordId
  **/
  @Schema(required = true, description = "Unique ID for the item, used by the contract system")
   ...
   * @return runs
  **/
  @Schema(description = "Number of runs remaining if the blueprint is a copy, -1 if it is an original")
  ...
  **/
  @Schema(description = "Time Efficiency Level of the blueprint")
   ...
   * @return typeId
  **/
  @Schema(required = true, description = "Type ID for item")
