...
public class GetOpportunitiesGroupsGroupIdOk {
  ...
  **/
  @Schema(required = true, description = "The groups that are connected to this group on the opportunities map")
  ...
  **/
   ...
   * @return notification
  **/
  @Schema(required = true, description = "notification string")
  ...
  **/
  @Schema(required = true, description = "Tasks need to complete for this group")
