...
public class GetFleetsFleetIdOk {
   ...
   * @return isFreeMove
  **/
  @Schema(required = true, description = "Is free-move enabled")
   ...
   * @return isRegistered
  **/
  @Schema(required = true, description = "Does the fleet have an active fleet advertisement")
  ...
  **/
  @Schema(required = true, description = "Is EVE Voice enabled")
   ...
   * @return motd
  **/
  @Schema(required = true, description = "Fleet MOTD in CCP flavoured HTML")
