...
public class GetCharactersCharacterIdWalletJournal200Ok {
  ...
  public enum ContextIdTypeEnum {
    ...
    public static ContextIdTypeEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<ContextIdTypeEnum> {
      ...
      public ContextIdTypeEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return ContextIdTypeEnum.fromValue((String)(value));
      }
    }
  ...
  **/
   ...
   * @return date
  **/
  @Schema(required = true, description = "Date and time of transaction")
   ...
   * @return description
  **/
  @Schema(required = true, description = "The reason for the transaction, mirrors what is seen in the client")
   ...
   * @return firstPartyId
  **/
  @Schema(description = "The id of the first party involved in the transaction. This attribute has no consistency and is different or non existant for particular ref_types. The description attribute will help make sense of what this attribute means. For more info about the given ID it can be dropped into the /universe/names/ ESI route to determine its type and name")
   ...
   * @return id
  **/
  @Schema(required = true, description = "Unique journal reference ID")
  public Long getId() {
    return id;
  }
  ...
  **/
   ...
   * @return refType
  **/
  @Schema(required = true, description = "\"The transaction type for the given. transaction. Different transaction types will populate different attributes.\"")
  ...
  **/
  @Schema(description = "The id of the second party involved in the transaction. This attribute has no consistency and is different or non existant for particular ref_types. The description attribute will help make sense of what this attribute means. For more info about the given ID it can be dropped into the /universe/names/ ESI route to determine its type and name")
