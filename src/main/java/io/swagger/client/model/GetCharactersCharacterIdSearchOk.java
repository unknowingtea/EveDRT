...
public class GetCharactersCharacterIdSearchOk {
   ...
   * @return agent
  **/
  @Schema(description = "agent array")
   ...
   * @return alliance
  **/
  @Schema(description = "alliance array")
   ...
   * @return character
  **/
  @Schema(description = "character array")
  ...
  **/
  @Schema(description = "constellation array")
   ...
   * @return corporation
  **/
  @Schema(description = "corporation array")
   ...
   * @return faction
  **/
  @Schema(description = "faction array")
  ...
  **/
  @Schema(description = "inventory_type array")
   ...
   * @return region
  **/
  @Schema(description = "region array")
   ...
   * @return solarSystem
  **/
  @Schema(description = "solar_system array")
   ...
   * @return station
  **/
  @Schema(description = "station array")
   ...
   * @return structure
  **/
  @Schema(description = "structure array")
