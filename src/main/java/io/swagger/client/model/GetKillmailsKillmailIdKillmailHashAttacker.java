 ...
 * attacker object
 */
@Schema(description = "attacker object")
...
public class GetKillmailsKillmailIdKillmailHashAttacker {
  ...
  **/
   ...
   * @return damageDone
  **/
  @Schema(required = true, description = "damage_done integer")
  ...
  **/
   ...
   * @return finalBlow
  **/
  @Schema(required = true, description = "Was the attacker the one to achieve the final blow ")
  ...
  **/
  @Schema(required = true, description = "Security status for the attacker ")
   ...
   * @return shipTypeId
  **/
  @Schema(description = "What ship was the attacker flying ")
   ...
   * @return weaponTypeId
  **/
  @Schema(description = "What weapon was used by the attacker for the kill ")
