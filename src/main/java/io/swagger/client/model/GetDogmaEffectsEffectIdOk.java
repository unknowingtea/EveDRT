...
public class GetDogmaEffectsEffectIdOk {
  ...
  **/
  @Schema(description = "disallow_auto_repeat boolean")
  ...
  **/
  @Schema(description = "discharge_attribute_id integer")
   ...
   * @return displayName
  **/
  @Schema(description = "display_name string")
  ...
  **/
  @Schema(description = "duration_attribute_id integer")
  ...
  **/
  @Schema(description = "effect_category integer")
  ...
  **/
  @Schema(description = "electronic_chance boolean")
  ...
  **/
  @Schema(description = "falloff_attribute_id integer")
   ...
   * @return iconId
  **/
  @Schema(description = "icon_id integer")
   ...
   * @return isAssistance
  **/
  @Schema(description = "is_assistance boolean")
   ...
   * @return isOffensive
  **/
  @Schema(description = "is_offensive boolean")
   ...
   * @return isWarpSafe
  **/
  @Schema(description = "is_warp_safe boolean")
   ...
   * @return modifiers
  **/
  @Schema(description = "modifiers array")
  ...
  **/
  @Schema(description = "post_expression integer")
  ...
  **/
  @Schema(description = "pre_expression integer")
   ...
   * @return published
  **/
  @Schema(description = "published boolean")
  ...
  **/
  @Schema(description = "range_attribute_id integer")
   ...
   * @return rangeChance
  **/
  @Schema(description = "range_chance boolean")
  ...
  **/
  @Schema(description = "tracking_speed_attribute_id integer")
