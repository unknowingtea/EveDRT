...
public class GetSovereigntyStructures200Ok {
   ...
   * @return allianceId
  **/
  @Schema(required = true, description = "The alliance that owns the structure. ")
  ...
  **/
  @Schema(required = true, description = "Solar system in which the structure is located. ")
   ...
   * @return structureId
  **/
  @Schema(required = true, description = "Unique item ID for this structure.")
  ...
  **/
  @Schema(required = true, description = "A reference to the type of structure this is. ")
  ...
  **/
  @Schema(description = "The time at which the next or current vulnerability window ends. At the end of a vulnerability window the next window is recalculated and locked in along with the vulnerabilityOccupancyLevel. If the structure is not in 100% entosis control of the defender, it will go in to 'overtime' and stay vulnerable for as long as that situation persists. Only once the defenders have 100% entosis control and has the vulnerableEndTime passed does the vulnerability interval expire and a new one is calculated. ")
  ...
  **/
  @Schema(description = "The next time at which the structure will become vulnerable. Or the start time of the current window if current time is between this and vulnerableEndTime. ")
