...
import io.swagger.client.model.GetUniverseSystemsSystemIdPlanet;
import io.swagger.client.model.GetUniverseSystemsSystemIdPosition;
...
public class GetUniverseSystemsSystemIdOk {
  ...
  **/
  @Schema(required = true, description = "The constellation this solar system is in")
  ...
  **/
  ...
  public GetUniverseSystemsSystemIdOk addPlanetsItem(GetUniverseSystemsSystemIdPlanet planetsItem) {
    if (this.planets == null) {
      this.planets = new ArrayList<GetUniverseSystemsSystemIdPlanet>();
    }
   ...
   * @return planets
  **/
  @Schema(description = "planets array")
  ...
  **/
  @Schema(description = "security_class string")
  ...
  **/
  @Schema(required = true, description = "security_status number")
   ...
   * @return starId
  **/
  @Schema(description = "star_id integer")
   ...
   * @return stargates
  **/
  @Schema(description = "stargates array")
