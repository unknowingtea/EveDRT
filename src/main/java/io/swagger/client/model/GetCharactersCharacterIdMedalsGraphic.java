 ...
 * graphic object
 */
@Schema(description = "graphic object")
...
public class GetCharactersCharacterIdMedalsGraphic {
   ...
   * @return color
  **/
  @Schema(description = "color integer")
   ...
   * @return graphic
  **/
  @Schema(required = true, description = "graphic string")
   ...
   * @return layer
  **/
  @Schema(required = true, description = "layer integer")
   ...
   * @return part
  **/
  @Schema(required = true, description = "part integer")
