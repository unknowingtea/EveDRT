 ...
 * victim object
 */
@Schema(description = "victim object")
...
public class GetKillmailsKillmailIdKillmailHashVictim {
  ...
  **/
   ...
   * @return damageTaken
  **/
  @Schema(required = true, description = "How much total damage was taken by the victim ")
  ...
  **/
   ...
   * @return shipTypeId
  **/
  @Schema(required = true, description = "The ship that the victim was piloting and was destroyed ")
