...
import io.swagger.client.model.GetCharactersCharacterIdClonesHomeLocation;
import io.swagger.client.model.GetCharactersCharacterIdClonesJumpClone;
...
public class GetCharactersCharacterIdClonesOk {
  ...
  **/
   ...
   * @return jumpClones
  **/
  @Schema(required = true, description = "jump_clones array")
  ...
  **/
  @Schema(description = "last_clone_jump_date string")
  ...
  **/
  @Schema(description = "last_station_change_date string")
