...
import io.swagger.client.model.GetCharactersCharacterIdPlanetsPlanetIdContent;
...
public class GetCharactersCharacterIdPlanetsPlanetIdPin {
   ...
   * @return contents
  **/
  @Schema(description = "contents array")
   ...
   * @return expiryTime
  **/
  @Schema(description = "expiry_time string")
  ...
  **/
   ...
   * @return installTime
  **/
  @Schema(description = "install_time string")
  ...
  **/
  @Schema(description = "last_cycle_start string")
  ...
  **/
   ...
   * @return pinId
  **/
  @Schema(required = true, description = "pin_id integer")
   ...
   * @return schematicId
  **/
  @Schema(description = "schematic_id integer")
