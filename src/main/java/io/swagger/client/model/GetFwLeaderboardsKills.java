...
import io.swagger.client.model.GetFwLeaderboardsActiveTotalActiveTotal;
import io.swagger.client.model.GetFwLeaderboardsLastWeekLastWeek;
import io.swagger.client.model.GetFwLeaderboardsYesterdayYesterday;
 ...
 */
@Schema(description = "Top 4 rankings of factions by number of kills from yesterday, last week and in total")
...
public class GetFwLeaderboardsKills {
   ...
   * @return activeTotal
  **/
  @Schema(required = true, description = "Top 4 ranking of factions active in faction warfare by total kills. A faction is considered \"active\" if they have participated in faction warfare in the past 14 days")
   ...
   * @return lastWeek
  **/
  @Schema(required = true, description = "Top 4 ranking of factions by kills in the past week")
   ...
   * @return yesterday
  **/
  @Schema(required = true, description = "Top 4 ranking of factions by kills in the past day")
