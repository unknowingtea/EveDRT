...
public class GetCharactersCharacterIdBlueprints200Ok {
  ...
  public enum LocationFlagEnum {
    ...
    public static LocationFlagEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<LocationFlagEnum> {
      ...
      public LocationFlagEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return LocationFlagEnum.fromValue((String)(value));
      }
    }
   ...
   * @return itemId
  **/
  @Schema(required = true, description = "Unique ID for this item.")
   ...
   * @return locationFlag
  **/
  @Schema(required = true, description = "Type of the location_id")
   ...
   * @return locationId
  **/
  @Schema(required = true, description = "References a station, a ship or an item_id if this blueprint is located within a container. If the return value is an item_id, then the Character AssetList API must be queried to find the container using the given item_id to determine the correct location of the Blueprint.")
  ...
  **/
  @Schema(required = true, description = "Material Efficiency Level of the blueprint.")
   ...
   * @return quantity
  **/
  @Schema(required = true, description = "A range of numbers with a minimum of -2 and no maximum value where -1 is an original and -2 is a copy. It can be a positive integer if it is a stack of blueprint originals fresh from the market (e.g. no activities performed on them yet).")
   ...
   * @return runs
  **/
  @Schema(required = true, description = "Number of runs remaining if the blueprint is a copy, -1 if it is an original.")
  ...
  **/
  @Schema(required = true, description = "Time Efficiency Level of the blueprint.")
