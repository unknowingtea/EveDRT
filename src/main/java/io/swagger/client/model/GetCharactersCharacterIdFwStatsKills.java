 ...
 */
@Schema(description = "Summary of kills done by the given character against enemy factions")
...
public class GetCharactersCharacterIdFwStatsKills {
   ...
   * @return lastWeek
  **/
  @Schema(required = true, description = "Last week's total number of kills by a given character against enemy factions")
   ...
   * @return total
  **/
  @Schema(required = true, description = "Total number of kills by a given character against enemy factions since the character enlisted")
   ...
   * @return yesterday
  **/
  @Schema(required = true, description = "Yesterday's total number of kills by a given character against enemy factions")
