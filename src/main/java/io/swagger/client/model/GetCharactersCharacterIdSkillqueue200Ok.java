...
public class GetCharactersCharacterIdSkillqueue200Ok {
   ...
   * @return finishDate
  **/
  @Schema(description = "Date on which training of the skill will complete. Omitted if the skill queue is paused.")
  ...
  **/
  @Schema(required = true, description = "finished_level integer")
   ...
   * @return levelEndSp
  **/
  @Schema(description = "level_end_sp integer")
   ...
   * @return levelStartSp
  **/
  @Schema(description = "Amount of SP that was in the skill when it started training it's current level. Used to calculate % of current level complete.")
  ...
  **/
  @Schema(required = true, description = "queue_position integer")
  ...
  **/
   ...
   * @return startDate
  **/
  @Schema(description = "start_date string")
  ...
  **/
  @Schema(description = "training_start_sp integer")
