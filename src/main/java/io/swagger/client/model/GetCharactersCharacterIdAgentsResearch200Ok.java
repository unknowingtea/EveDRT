...
public class GetCharactersCharacterIdAgentsResearch200Ok {
   ...
   * @return agentId
  **/
  @Schema(required = true, description = "agent_id integer")
   ...
   * @return pointsPerDay
  **/
  @Schema(required = true, description = "points_per_day number")
  ...
  **/
  @Schema(required = true, description = "remainder_points number")
   ...
   * @return skillTypeId
  **/
  @Schema(required = true, description = "skill_type_id integer")
   ...
   * @return startedAt
  **/
  @Schema(required = true, description = "started_at string")
