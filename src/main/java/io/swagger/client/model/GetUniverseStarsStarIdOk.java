...
public class GetUniverseStarsStarIdOk {
  ...
  public enum SpectralClassEnum {
    ...
    public static SpectralClassEnum fromValue(String input) {
    ...
    public static class Adapter extends TypeAdapter<SpectralClassEnum> {
      ...
      public SpectralClassEnum read(final JsonReader jsonReader) throws IOException {
        ...
        return SpectralClassEnum.fromValue((String)(value));
      }
    }
   ...
   * @return age
  **/
  @Schema(required = true, description = "Age of star in years")
  public Long getAge() {
    return age;
  }
   ...
   * @return luminosity
  **/
  @Schema(required = true, description = "luminosity number")
  ...
  **/
   ...
   * @return radius
  **/
  @Schema(required = true, description = "radius integer")
  ...
  **/
  @Schema(required = true, description = "spectral_class string")
   ...
   * @return temperature
  **/
  @Schema(required = true, description = "temperature integer")
