...
public class GetCharactersCharacterIdOrdersHistory200Ok {
   ...
   * @return duration
  **/
  @Schema(required = true, description = "Number of days the order was valid for (starting from the issued date). An order expires at time issued + duration")
  ...
  **/
  @Schema(required = true, description = "Signifies whether the buy/sell order was placed on behalf of a corporation.")
  ...
  **/
   ...
   * @return state
  **/
  @Schema(required = true, description = "Current order state")
