 ...
 */
@Schema(description = "The aggressor corporation or alliance that declared this war, only contains either corporation_id or alliance_id")
...
public class GetWarsWarIdAggressor {
   ...
   * @return allianceId
  **/
  @Schema(description = "Alliance ID if and only if the aggressor is an alliance")
  ...
  **/
  @Schema(description = "Corporation ID if and only if the aggressor is a corporation")
   ...
   * @return iskDestroyed
  **/
  @Schema(required = true, description = "ISK value of ships the aggressor has destroyed")
   ...
   * @return shipsKilled
  **/
  @Schema(required = true, description = "The number of ships the aggressor has killed")
