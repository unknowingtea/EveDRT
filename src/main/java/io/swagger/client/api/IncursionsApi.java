...
public class IncursionsApi {
     ...
     */
    public com.squareup.okhttp.Call getIncursionsCall(String datasource, String ifNoneMatch, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public List<GetIncursions200Ok> getIncursions(String datasource, String ifNoneMatch) throws ApiException {
        ApiResponse<List<GetIncursions200Ok>> resp = getIncursionsWithHttpInfo(datasource, ifNoneMatch);
        return resp.getData();
    }
     ...
     */
    public com.squareup.okhttp.Call getIncursionsAsync(String datasource, String ifNoneMatch, final ApiCallback<List<GetIncursions200Ok>> callback) throws ApiException {
