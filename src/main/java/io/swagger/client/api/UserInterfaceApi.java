...
public class UserInterfaceApi {
     ...
     * @param body The details of mail to create (required)
     * @param datasource The server name you would like data from (optional, default to tranquility)
     * @param token Access token to use if unable to set a header (optional)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call postUiOpenwindowNewmailCall(PostUiOpenwindowNewmailNewMail body, String datasource, String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call postUiOpenwindowNewmailValidateBeforeCall(PostUiOpenwindowNewmailNewMail body, String datasource, String token, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'body' is set
        if (body == null) {
            throw new ApiException("Missing the required parameter 'body' when calling postUiOpenwindowNewmail(Async)");
        }
        
        com.squareup.okhttp.Call call = postUiOpenwindowNewmailCall(body, datasource, token, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void postUiOpenwindowNewmail(PostUiOpenwindowNewmailNewMail body, String datasource, String token) throws ApiException {
        postUiOpenwindowNewmailWithHttpInfo(body, datasource, token);
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> postUiOpenwindowNewmailWithHttpInfo(PostUiOpenwindowNewmailNewMail body, String datasource, String token) throws ApiException {
        com.squareup.okhttp.Call call = postUiOpenwindowNewmailValidateBeforeCall(body, datasource, token, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call postUiOpenwindowNewmailAsync(PostUiOpenwindowNewmailNewMail body, String datasource, String token, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = postUiOpenwindowNewmailValidateBeforeCall(body, datasource, token, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
}
